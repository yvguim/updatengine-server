...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'entity.packageprofile'
        db.add_column('inventory_entity', 'packageprofile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['deploy.packageprofile'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'entity.old_packageprofile'
        db.add_column('inventory_entity', 'old_packageprofile',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='old_packageprofile', null=True, on_delete=models.SET_NULL, to=orm['deploy.packageprofile']),
                      keep_default=False)

        # Adding field 'entity.force_packageprofile'
        db.add_column('inventory_entity', 'force_packageprofile',
                      self.gf('django.db.models.fields.CharField')(default='no', max_length=3),
                      keep_default=False)

        # Adding field 'entity.timeprofile'
        db.add_column('inventory_entity', 'timeprofile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['deploy.timeprofile'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'entity.old_timeprofile'
        db.add_column('inventory_entity', 'old_timeprofile',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='old_timeprofile', null=True, on_delete=models.SET_NULL, to=orm['deploy.timeprofile']),
                      keep_default=False)

        # Adding field 'entity.force_timeprofile'
        db.add_column('inventory_entity', 'force_timeprofile',
                      self.gf('django.db.models.fields.CharField')(default='no', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'entity.packageprofile'
        db.delete_column('inventory_entity', 'packageprofile_id')

        # Deleting field 'entity.old_packageprofile'
        db.delete_column('inventory_entity', 'old_packageprofile_id')

        # Deleting field 'entity.force_packageprofile'
        db.delete_column('inventory_entity', 'force_packageprofile')

        # Deleting field 'entity.timeprofile'
        db.delete_column('inventory_entity', 'timeprofile_id')

        # Deleting field 'entity.old_timeprofile'
        db.delete_column('inventory_entity', 'old_timeprofile_id')

        # Deleting field 'entity.force_timeprofile'
        db.delete_column('inventory_entity', 'force_timeprofile')
