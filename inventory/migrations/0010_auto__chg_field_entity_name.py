...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('inventory_entity', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'entity.name'
        db.alter_column('inventory_entity', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
