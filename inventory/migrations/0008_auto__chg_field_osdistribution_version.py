...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'osdistribution.version'
        db.alter_column('inventory_osdistribution', 'version', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'osdistribution.version'
        db.alter_column('inventory_osdistribution', 'version', self.gf('django.db.models.fields.CharField')(default='undefined', max_length=100))
