...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'software.uninstall'
        db.add_column('inventory_software', 'uninstall',
                      self.gf('django.db.models.fields.CharField')(default='undefined', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'software.uninstall'
        db.delete_column('inventory_software', 'uninstall')
