...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'software.version'
        db.alter_column('inventory_software', 'version', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'software.version'
        db.alter_column('inventory_software', 'version', self.gf('django.db.models.fields.CharField')(default='undefined', max_length=500))
