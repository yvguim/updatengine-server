...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'entity.redistrib_url'
        db.add_column(u'inventory_entity', 'redistrib_url',
                      self.gf('django.db.models.fields.TextField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'entity.redistrib_url'
        db.delete_column(u'inventory_entity', 'redistrib_url')
    ...
    models = {
        ...
        u'inventory.entity': {
            ...
            'redistrib_url': ('django.db.models.fields.TextField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
