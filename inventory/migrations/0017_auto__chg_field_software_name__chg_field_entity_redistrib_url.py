...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'software.name'
        db.alter_column(u'inventory_software', 'name', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'entity.redistrib_url'
        db.alter_column(u'inventory_entity', 'redistrib_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'software.name'
        db.alter_column(u'inventory_software', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'entity.redistrib_url'
        db.alter_column(u'inventory_entity', 'redistrib_url', self.gf('django.db.models.fields.TextField')(max_length=200, null=True))
    ...
    models = {
        ...
        u'inventory.entity': {
            ...
            'redistrib_url': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
