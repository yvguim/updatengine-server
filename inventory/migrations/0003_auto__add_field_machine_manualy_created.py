...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'machine.manualy_created'
        db.add_column('inventory_machine', 'manualy_created',
                      self.gf('django.db.models.fields.CharField')(default='yes', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'machine.manualy_created'
        db.delete_column('inventory_machine', 'manualy_created')
