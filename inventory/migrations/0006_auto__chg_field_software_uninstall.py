...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'software.uninstall'
        db.alter_column('inventory_software', 'uninstall', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'software.uninstall'
        db.alter_column('inventory_software', 'uninstall', self.gf('django.db.models.fields.CharField')(default='', max_length=500))
