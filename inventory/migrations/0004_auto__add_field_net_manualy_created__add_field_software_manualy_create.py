...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'net.manualy_created'
        db.add_column('inventory_net', 'manualy_created',
                      self.gf('django.db.models.fields.CharField')(default='yes', max_length=3),
                      keep_default=False)

        # Adding field 'software.manualy_created'
        db.add_column('inventory_software', 'manualy_created',
                      self.gf('django.db.models.fields.CharField')(default='yes', max_length=3),
                      keep_default=False)

        # Adding field 'osdistribution.manualy_created'
        db.add_column('inventory_osdistribution', 'manualy_created',
                      self.gf('django.db.models.fields.CharField')(default='yes', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'net.manualy_created'
        db.delete_column('inventory_net', 'manualy_created')

        # Deleting field 'software.manualy_created'
        db.delete_column('inventory_software', 'manualy_created')

        # Deleting field 'osdistribution.manualy_created'
        db.delete_column('inventory_osdistribution', 'manualy_created')
