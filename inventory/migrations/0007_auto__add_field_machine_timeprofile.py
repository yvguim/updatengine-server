...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'machine.timeprofile'
        db.add_column('inventory_machine', 'timeprofile',
    ...
    def backwards(self, orm):
        # Deleting field 'machine.timeprofile'
        db.delete_column('inventory_machine', 'timeprofile_id')
