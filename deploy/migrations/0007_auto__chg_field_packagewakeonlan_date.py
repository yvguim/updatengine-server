...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'packagewakeonlan.date'
        db.alter_column('deploy_packagewakeonlan', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'packagewakeonlan.date'
        db.alter_column('deploy_packagewakeonlan', 'date', self.gf('django.db.models.fields.DateField')())
