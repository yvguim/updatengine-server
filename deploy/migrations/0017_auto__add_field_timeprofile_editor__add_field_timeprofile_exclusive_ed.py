...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'timeprofile.editor'
        db.add_column(u'deploy_timeprofile', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'timeprofile.exclusive_editor'
        db.add_column(u'deploy_timeprofile', 'exclusive_editor',
                      self.gf('django.db.models.fields.CharField')(default='no', max_length=3),
                      keep_default=False)

        # Adding M2M table for field entity on 'timeprofile'
        m2m_table_name = db.shorten_name(u'deploy_timeprofile_entity')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('timeprofile', models.ForeignKey(orm[u'deploy.timeprofile'], null=False)),
            ('entity', models.ForeignKey(orm[u'inventory.entity'], null=False))
        ))
        db.create_unique(m2m_table_name, ['timeprofile_id', 'entity_id'])


    def backwards(self, orm):
        # Deleting field 'timeprofile.editor'
        db.delete_column(u'deploy_timeprofile', 'editor_id')

        # Deleting field 'timeprofile.exclusive_editor'
        db.delete_column(u'deploy_timeprofile', 'exclusive_editor')

        # Removing M2M table for field entity on 'timeprofile'
        db.delete_table(db.shorten_name(u'deploy_timeprofile_entity'))
