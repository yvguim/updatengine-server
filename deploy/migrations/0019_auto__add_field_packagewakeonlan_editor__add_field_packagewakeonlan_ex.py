...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'packagewakeonlan.editor'
        db.add_column(u'deploy_packagewakeonlan', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'packagewakeonlan.exclusive_editor'
        db.add_column(u'deploy_packagewakeonlan', 'exclusive_editor',
                      self.gf('django.db.models.fields.CharField')(default='no', max_length=3),
                      keep_default=False)

        # Adding M2M table for field entity on 'packagewakeonlan'
        m2m_table_name = db.shorten_name(u'deploy_packagewakeonlan_entity')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('packagewakeonlan', models.ForeignKey(orm[u'deploy.packagewakeonlan'], null=False)),
            ('entity', models.ForeignKey(orm[u'inventory.entity'], null=False))
        ))
        db.create_unique(m2m_table_name, ['packagewakeonlan_id', 'entity_id'])


    def backwards(self, orm):
        # Deleting field 'packagewakeonlan.editor'
        db.delete_column(u'deploy_packagewakeonlan', 'editor_id')

        # Deleting field 'packagewakeonlan.exclusive_editor'
        db.delete_column(u'deploy_packagewakeonlan', 'exclusive_editor')

        # Removing M2M table for field entity on 'packagewakeonlan'
        db.delete_table(db.shorten_name(u'deploy_packagewakeonlan_entity'))
