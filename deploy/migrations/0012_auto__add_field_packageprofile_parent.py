...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'packageprofile.parent'
        db.add_column('deploy_packageprofile', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='child', null=True, on_delete=models.SET_NULL, to=orm['deploy.packageprofile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'packageprofile.parent'
        db.delete_column('deploy_packageprofile', 'parent_id')
