...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'packagehistory.category'
        db.add_column(u'deploy_packagehistory', 'category',
                      self.gf('django.db.models.fields.CharField')(default='Information', max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'packagehistory.category'
        db.delete_column(u'deploy_packagehistory', 'category')
    ...
    models = {
        ...
        u'deploy.packagehistory': {
            ...
            'category': ('django.db.models.fields.CharField', [], {'default': "'Information'", 'max_length': '30', 'null': 'True', 'blank': 'True'}),
