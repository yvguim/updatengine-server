...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('deploy_impex', (
            ...
            ('filename', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100, null=True, blank=True)),
            ('package', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['deploy.package'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('deploy', ['impex'])


    def backwards(self, orm):
        # Deleting model 'impex'
        db.delete_table('deploy_impex')


    models = {
        'deploy.impex': {
            'Meta': {'object_name': 'impex'},
            ...
            'package': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['deploy.package']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
