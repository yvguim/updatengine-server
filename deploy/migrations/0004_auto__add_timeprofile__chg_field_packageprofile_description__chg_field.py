...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'timeprofile'
        db.create_table('deploy_timeprofile', (
        ...
        db.send_create_signal('deploy', ['timeprofile'])


        # Changing field 'packageprofile.description'
        db.alter_column('deploy_packageprofile', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=500))

        # Changing field 'packageprofile.name'
        db.alter_column('deploy_packageprofile', 'name', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=100))

    def backwards(self, orm):
        # Deleting model 'timeprofile'
        db.delete_table('deploy_timeprofile')


        # Changing field 'packageprofile.description'
        db.alter_column('deploy_packageprofile', 'description', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'packageprofile.name'
        db.alter_column('deploy_packageprofile', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, null=True))
