...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'packagewakeonlan'
        db.create_table('deploy_packagewakeonlan', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('status', self.gf('django.db.models.fields.CharField')(default='Programmed', max_length=100)),
        ))
        db.send_create_signal('deploy', ['packagewakeonlan'])

        # Adding M2M table for field machines on 'packagewakeonlan'
        db.create_table('deploy_packagewakeonlan_machines', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('packagewakeonlan', models.ForeignKey(orm['deploy.packagewakeonlan'], null=False)),
            ('machine', models.ForeignKey(orm['inventory.machine'], null=False))
        ))
        db.create_unique('deploy_packagewakeonlan_machines', ['packagewakeonlan_id', 'machine_id'])


    def backwards(self, orm):
        # Deleting model 'packagewakeonlan'
        db.delete_table('deploy_packagewakeonlan')

        # Removing M2M table for field machines on 'packagewakeonlan'
        db.delete_table('deploy_packagewakeonlan_machines')
