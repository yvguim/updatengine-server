...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'packagecondition.softwareversion'
        db.alter_column('deploy_packagecondition', 'softwareversion', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'packagecondition.softwarename'
        db.alter_column('deploy_packagecondition', 'softwarename', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'packagecondition.softwareversion'
        db.alter_column('deploy_packagecondition', 'softwareversion', self.gf('django.db.models.fields.CharField')(default='undefined', max_length=500))

        # Changing field 'packagecondition.softwarename'
        db.alter_column('deploy_packagecondition', 'softwarename', self.gf('django.db.models.fields.CharField')(default='undefined', max_length=100))
