...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'package.editor'
        db.add_column(u'deploy_package', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'package.exclusive_editor'
        db.add_column(u'deploy_package', 'exclusive_editor',
                      self.gf('django.db.models.fields.CharField')(default='no', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'package.editor'
        db.delete_column(u'deploy_package', 'editor_id')

        # Deleting field 'package.exclusive_editor'
        db.delete_column(u'deploy_package', 'exclusive_editor')
