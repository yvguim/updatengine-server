...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'package.ignoreperiod'
        db.add_column('deploy_package', 'ignoreperiod',
                      self.gf('django.db.models.fields.CharField')(default='no', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'package.ignoreperiod'
        db.delete_column('deploy_package', 'ignoreperiod')
