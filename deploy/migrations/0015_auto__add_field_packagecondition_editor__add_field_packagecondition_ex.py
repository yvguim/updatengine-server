...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'packagecondition.editor'
        db.add_column(u'deploy_packagecondition', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'packagecondition.exclusive_editor'
        db.add_column(u'deploy_packagecondition', 'exclusive_editor',
                      self.gf('django.db.models.fields.CharField')(default='no', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'packagecondition.editor'
        db.delete_column(u'deploy_packagecondition', 'editor_id')

        # Deleting field 'packagecondition.exclusive_editor'
        db.delete_column(u'deploy_packagecondition', 'exclusive_editor')
