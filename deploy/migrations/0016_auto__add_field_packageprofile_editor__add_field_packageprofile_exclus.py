...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'packageprofile.editor'
        db.add_column(u'deploy_packageprofile', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'packageprofile.exclusive_editor'
        db.add_column(u'deploy_packageprofile', 'exclusive_editor',
                      self.gf('django.db.models.fields.CharField')(default='no', max_length=3),
                      keep_default=False)

        # Adding M2M table for field entity on 'packageprofile'
        m2m_table_name = db.shorten_name(u'deploy_packageprofile_entity')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('packageprofile', models.ForeignKey(orm[u'deploy.packageprofile'], null=False)),
            ('entity', models.ForeignKey(orm[u'inventory.entity'], null=False))
        ))
        db.create_unique(m2m_table_name, ['packageprofile_id', 'entity_id'])


    def backwards(self, orm):
        # Deleting field 'packageprofile.editor'
        db.delete_column(u'deploy_packageprofile', 'editor_id')

        # Deleting field 'packageprofile.exclusive_editor'
        db.delete_column(u'deploy_packageprofile', 'exclusive_editor')

        # Removing M2M table for field entity on 'packageprofile'
        db.delete_table(db.shorten_name(u'deploy_packageprofile_entity'))
